...
def print_banner_v4():
    clr()
    print(C.rainbow(BANNER_V4))
    print(C.gradient(TOKEN_ART_V4))
    print(f"  {C.BG_RED}{C.WHITE}{C.BOLD}🔥 DISCORD TOKEN CHECKER V4.0 - HARDCORE EDITION 🔥{C.RESET}")
    print(f"  {C.YELLOW}{blink('⚡')}{C.RESET} {C.CYAN}Multi-Threading • Token Hacking • Info Grabber • Bruteforce{C.RESET} {C.YELLOW}{blink('⚡')}{C.RESET}")
