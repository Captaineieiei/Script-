...
NovaHub["38"]["ClipsDescendants"] = false;
...
NovaHub["39"]["AnchorPoint"] = Vector2.new(0, 0);
NovaHub["39"]["ClipsDescendants"] = false;
NovaHub["39"]["Size"] = UDim2.new(0, 280, 1, -35);
NovaHub["39"]["Position"] = UDim2.new(1, 15, 0, 35);
...
NovaHub["102"]["AnchorPoint"] = Vector2.new(1, 0);
NovaHub["102"]["Size"] = UDim2.new(0, 280, 1, 0);
NovaHub["102"]["Position"] = UDim2.new(1, -10, 0, 10);
